    ...
    <div className='container'>
      <div className='about-card'>
        <div className='card-body'>
          <h4 className="large-title">About: EMC</h4>
          <br/>
          <p className='font medium-text'>EMC IT Solutions is a full service, I.T. solutions vendor and MSP (Managed Services Provider).  
            EMC Provides full solution, I.T. Management, staff augmentation, and supplementary I.T. services to other I.T. 
